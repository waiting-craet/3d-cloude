  ...
  try {
    ...
    if (type === '3d') {
      ...
      const nodesData = [
        ...
        ['node1', '中心节点', '这是中心节点的描述', 0, 0, 0],
        ['node2', '技术节点', '这是技术节点的描述', 100, 0, 0],
        ['node3', '业务节点', '这是业务节点的描述', 0, 100, 0],
        ['node4', '开发节点', '这是开发节点的描述', 0, 0, 100],
      ]
      ...
      const nodesData = [
        ...
        ['node1', '节点A', '这是节点A的描述', 100, 100],
        ['node2', '节点B', '这是节点B的描述', 300, 100],
        ['node3', '节点C', '这是节点C的描述', 200, 300],
      ]
      const nodesSheet = XLSX.utils.aoa_to_sheet(nodesData)
      XLSX.utils.book_append_sheet(wb, nodesSheet, 'Nodes')
