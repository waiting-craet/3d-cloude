              ...
              <table style={{
                ...
                <thead>
                  <tr style={{ background: '#f8f9fa' }}>
                    <th style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #e5e5e5' }}>源节点</th>
                    <th style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #e5e5e5' }}>关系</th>
                    <th style={{ padding: '8px', textAlign: 'left', borderBottom: '1px solid #e5e5e5' }}>目标节点</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td style={{ padding: '8px', borderBottom: '1px solid #f0f0f0' }}>节点A</td>
                    <td style={{ padding: '8px', borderBottom: '1px solid #f0f0f0' }}>连接</td>
                    <td style={{ padding: '8px', borderBottom: '1px solid #f0f0f0' }}>节点B</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '8px', borderBottom: '1px solid #f0f0f0' }}>节点A</td>
                    <td style={{ padding: '8px', borderBottom: '1px solid #f0f0f0' }}>包含</td>
                    <td style={{ padding: '8px', borderBottom: '1px solid #f0f0f0' }}>节点C</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '8px' }}>节点B</td>
                    <td style={{ padding: '8px' }}>引用</td>
                    <td style={{ padding: '8px' }}>节点C</td>
                  </tr>
                </tbody>
              </table>
              <div style={{
                ...
                <div>• 源节点和目标节点为必填字段</div>
                <div>• 关系字段为可选</div>
                <div>• 系统自动提取节点：节点A、节点B、节点C</div>
                <div style={{ marginTop: '6px' }}>
                  <a 
                    href="/templates/QUICK-START.md" 
                    target="_blank"
                    style={{
                      color: '#00bfa5',
                      textDecoration: 'none',
